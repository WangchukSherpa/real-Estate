          ...
          <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
            ...
            <div className='flex gap-4'>
              ...
              {listing.type === 'rent' ? '₹'+[`${+listing.regularPrice } /month`] : '₹'+[`${+listing.regularPrice } `] }
               ...
               {listing.offer && (
                <p className='bg-sky-900 w-full max-w-[200px] text-white text-center p-1 rounded-md'>
              {listing.type === 'rent' ? 'saving ₹'+[`${listing.discountPrice} /month`] : 'saving ₹'+[`${listing.discountPrice} `] }
                </p>
              )}
            </div>
